set nocompatible " must be first line
    ...
    fun SetupVAM()
      ...
      call vam#ActivateAddons(['php_localvarcheck', 'delimitMate', 'checksyntax', 'HTML_AutoCloseTag', 'fugitive', 'phpfolding', 'phpcomplete', 'php_check_syntax', 'PIV', 'DirDiff', 'vim-twig', 'The_NERD_tree', 'matchit.zip', 'taglist'], {'auto_install' : 1})
